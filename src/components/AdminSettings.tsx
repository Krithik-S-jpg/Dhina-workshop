...
import { ArrowLeft, Shield, Percent, AlertTriangle } from 'lucide-react';
        ...
        <div className="max-w-2xl mx-auto space-y-8">
          ...
          <div className="bg-white rounded-xl shadow-lg p-6">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <h2 className="text-xl font-bold text-slate-800">Stock Notifications</h2>
            </div>
            <div>
              ...
              <p className="text-sm text-slate-500 mt-2">
                Products with stock below this number will trigger a low stock alert.
              </p>
            </div>
          </div>
